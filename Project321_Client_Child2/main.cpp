...
//int main()
//{
//    cout << "\t\t....FILEMAPPING CLIENT or CHILD 2...." << endl;
//    cout << endl;
//
//
...
//    cout << "DATA READING FROM SERVER or PARENT PROCESS -> " << lpBuffer << endl;
//
//    string response;
//    while (true)
//    {
//        cout << "DATA READING FROM SERVER or PARENT PROCESS -> " << lpBuffer << endl;
//        cout << "Respond with up or down: ";
//        cin >> response;
...
int main()
{
    ...
    olc3DGraphics demo(mappedViewChess[0], 2);
